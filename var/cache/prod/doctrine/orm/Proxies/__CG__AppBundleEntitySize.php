 ...
 */
class Size extends \AppBundle\Entity\Size implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Size' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Size' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Size' . "\0" . 'precio', '' . "\0" . 'AppBundle\\Entity\\Size' . "\0" . 'impuesto'];
        }
