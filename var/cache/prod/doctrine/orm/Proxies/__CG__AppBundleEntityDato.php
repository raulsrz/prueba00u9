 ...
 */
class Dato extends \AppBundle\Entity\Dato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'web', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'datobancario', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'titular', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'iban', '' . "\0" . 'AppBundle\\Entity\\Dato' . "\0" . 'bic'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dato $proxy) {
    ...
    public function getDatobancario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDatobancario', []);

        return parent::getDatobancario();
    }
    ...
    public function setDatobancario($datobancario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDatobancario', [$datobancario]);

        return parent::setDatobancario($datobancario);
    }
